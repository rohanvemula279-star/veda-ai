"""Check for and apply fast-forward updates from the Veda GitHub repository."""
...
REMOTE = "https://github.com/titechprabhasolutions/Veda-Echo.git"
BRANCH = "main"
...
def update_from_github(base_dir: Path) -> bool:
    ...
    if os.environ.get("VEDA_SKIP_UPDATE") == "1":
        return False
