...
def _trim_to_limit(memory: dict) -> dict:
    try:
        ...
        print(f"[Memory] Trim check skipped: {e}")
...
def should_extract_memory(user_text: str, veda_text: str, api_key: str = "") -> bool:
    try:
        from llm_client import client

        combined = f"User: {user_text[:300]}\nVeda AI: {veda_text[:1000]}"
...
def extract_memory(user_text: str, veda_text: str, api_key: str = "") -> dict:
    try:
        from llm_client import client

        combined = f"User: {user_text[:600]}\nVeda AI: {veda_text[:300]}"
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a Veda AI assistant')\n"
            ...
            f"- Extract from BOTH user and Veda AI turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"Veda AI - Lite assistant"}}}},\n'
