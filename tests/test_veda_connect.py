...
from veda_connect.gateway.command_router import CommandRouter
from veda_connect.gateway.device_manager import DeviceManager
from veda_connect.gateway.capability_manager import CapabilityManager
from veda_connect.gateway.models import DeviceRecord
from veda_connect.gateway.pairing import PairingManager
from veda_connect.gateway.protocol import ProtocolTypes, build_message, validate_message
from veda_connect.gateway.websocket import ConnectionHub
...
def test_pairing_manager_returns_expiring_offer():
    ...
    assert offer.service == "_VEDA._tcp.local."
