package com.veda.connect.commands
...
import com.veda.connect.core.VedaConnectCapabilities
import com.veda.connect.core.CommandResult
import com.veda.connect.device.AndroidDeviceInfoProvider
...
class DeviceCommandHandler(private val context: Context) {
    ...
    private fun getDeviceInfo(): CommandResult {
        ...
        return CommandResult(
            ...
            data = mapOf(
                ...
                "capabilities" to VedaConnectCapabilities.INITIAL,
            ),
        )
    }
    ...
    private fun unlockPhone(parameters: Map<String, Any?>): CommandResult {
        ...
        val service = com.veda.connect.accessibility.VedaAccessibilityService.instance
        if (service == null) {
            return CommandResult(false, errorCode = "ACCESSIBILITY_DISABLED", error = "Veda Accessibility Service is not enabled.")
        }
