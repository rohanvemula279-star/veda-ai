...
def run(parameters: dict | None = None, player=None, session_memory=None) -> str:
    """Action entry point for system monitoring / health."""
    try:
        from actions.system_manager import run as sm_run
        return sm_run(parameters or {}, player=player, session_memory=session_memory)
