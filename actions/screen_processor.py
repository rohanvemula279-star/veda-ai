...
SYSTEM_PROMPT = (
    "You are Veda AI - Lite, an open-source assistant. "
    ...
    "Be concise, smart, and helpful like an advanced AI assistant for Rohan. "
            ...
            async for response in self._session.receive():
                ...
                if sc.turn_complete:
                    if transcript_buf and self._player:
                        ...
                        if full:
                            self._player.write_log(f"Veda AI: {full}")
