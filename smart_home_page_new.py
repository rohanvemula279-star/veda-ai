...
class AddDeviceDialog(QDialog):
    ...
    def _build_auth_form(self):
        ...
        self._account_label.setPlaceholderText("Example: Home, Rohan, Bedroom Hub")
...
class VedaHomePage(QWidget):
    """Modern Smart Home page for the companion dashboard."""
    ...
    def __init__(self, parent=None, smart_home_mgr=None):
        ...
        self.setObjectName("VedaHomePageModern")
        self.setStyleSheet(f"QWidget#VedaHomePageModern {{ background: transparent; }} QScrollArea {{ background: transparent; border: none; }}")
    ...
    def _animate_voice(self):
        ...
        if hasattr(self, "_voice_cmd_lbl") and self._voice_cmd_lbl:
            self._voice_cmd_lbl.setText({"Idle": '"Veda"', "Listening": '"Turn bedroom fan to speed 4"', "Thinking": '"Understanding..."', "Executing": '"Applying command..."', "Completed": '"Done"'}.get(self._voice_state, '"Veda"'))
